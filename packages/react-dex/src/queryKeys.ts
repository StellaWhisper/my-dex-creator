...
export const QueryKeys = {
  ...
  swapRoute: (param: UseSwapRouteQueryParams) => [
    "swapRoute",
    param.chain,
    param.swapRouteInput.dex as string,
    param.swapRouteInput.userAddress,
    param.swapRouteInput.priorityFee ?? "",
    param.swapRouteInput.amount,
    param.swapRouteInput.swapMode as string,
    param.swapRouteInput.slippage.toString(),
    param.swapRouteInput.inputMint ?? "",
    param.swapRouteInput.outputMint ?? "",
  ],
